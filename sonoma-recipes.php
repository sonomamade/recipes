 ...
 */
if ( ! function_exists('sonoma_recipe_post_type') ) {
...
add_action( 'init', 'sonoma_recipe_post_type', 0 );

}


/**
 * Register Recipe Ingredients Taxonomy
 */

if ( ! function_exists( 'sonoma_recipe_taxonomy_ingredient' ) ) {
...
// Hook into the 'init' action
add_action( 'init', 'sonoma_recipe_taxonomy_ingredient', 0 );

}

/**
 * Register Recipe Collection Taxonomy
 */

if ( ! function_exists( 'sonoma_recipe_taxonomy_collection' ) ) {
...
// Hook into the 'init' action
add_action( 'init', 'sonoma_recipe_taxonomy_collection', 0 );

}

/**
 * Register Recipe Allergy Taxonomy
 */

if ( ! function_exists( 'sonoma_recipe_taxonomy_allergy' ) ) {
...
// Hook into the 'init' action
add_action( 'init', 'sonoma_recipe_taxonomy_allergy', 0 );

}


/**
 * Register Recipe Field Groups if ACF Pro is installed
 */
